...
#
# ## Handover packages (PROD transfer)
#
# Self-contained folders for ops handover (pick one per cluster):
# - [handover/prom/agent-1](../handover/prom/agent-1) — v1 GetLogs
# - [handover/prom/agent-2](../handover/prom/agent-2) — v2 DaemonSet
#
# See [handover/prom/README.md](../handover/prom/README.md).

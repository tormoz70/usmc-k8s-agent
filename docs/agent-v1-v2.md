...
Готовые пакеты для передачи на площадку (самодостаточные папки):

- [`handover/prom/agent-1`](../handover/prom/agent-1) — Agent 1 / v1
- [`handover/prom/agent-2`](../handover/prom/agent-2) — Agent 2 / v2

См. [`handover/prom/README.md`](../handover/prom/README.md).
